...
class Assets
{
	...
	{
		wp_register_script('hcms-plugins-category-js', AQUILA_BUILD_JS_URI . '/category.js', [], false, true);
		wp_register_style('hcms-plugins-category-css', AQUILA_BUILD_CSS_URI . '/category.css', [], false, false);
