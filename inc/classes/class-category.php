...
class Category
{
    ...
    {
        include_once AQUILA_DIR_PATH . '/category-img-form.php';
    }
    ...
    {
        if (!empty($_POST['category-image-id'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
    ...
    { ?>
        <tr class="form-field term-group-wrap">
            <th scope="row">
                <label for="category-image-id"><?php esc_html_e('Category Image', 'bilmece'); ?></label>
            </th>
            <td>
                <?php
                ...
                <div>
                    <input type="button" class="button button-secondary hcms_tax_media_button <?php echo esc_attr($add_image_class); ?>" id="hcms_tax_media_button" name="hcms_tax_media_button" value="<?php esc_html_e('Add Image', 'aquila'); ?>" />
                    <input type="button" class="button button-secondary hcms_tax_media_remove <?php echo esc_attr($remove_image_class); ?>" id="hcms_tax_media_remove" name="hcms_tax_media_remove" value="<?php esc_html_e('Remove Image', 'aquila'); ?>" />
                </div>
            </td>
        </tr>
<?php
